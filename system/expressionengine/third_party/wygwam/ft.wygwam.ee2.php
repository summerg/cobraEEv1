...
class Wygwam_ft extends EE_Fieldtype {
	...
	function display_field($data)
	{
		...
		return $this->_hidden_input($all_settings['field_name'], $data)
		       . '<textarea id="'.$this->field_name.'" name="'.$this->field_name.'[new]">'.$data.'</textarea>';
	}
	...
	function display_cell($data)
	{
		...
		return $this->_hidden_input($this->cell_name, $data)
		       . '<textarea name="'.$this->cell_name.'[new]">'.$data.'</textarea>';
	}
